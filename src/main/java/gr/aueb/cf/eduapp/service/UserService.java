...
public class UserService implements IUserService{
    ...
    @Override
    @Transactional(rollbackFor = {EntityAlreadyExistsException.class, EntityInvalidArgumentException.class}) // περιλαμβάνει ολα τα runtime exception + 2 που προσθέτουμε
    ...
    public UserReadOnlyDTO getUserByUUID(UUID uuid) throws EntityNotFoundException {
         try{
             ...
             log.debug("User with uuid={} found successfully", uuid);  // debug για select, δεν έχουμε αλλαγή στη βάση για να βάλουμε info
             return mapper.mapToUserReadOnlyDTO(user);
